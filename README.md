...
| Results | `results/reference_<task>.csv` (`ResultsStore`) + `scripts/build_leaderboard.py` -> `docs/leaderboard.md`, `scripts/build_analysis.py` -> `docs/analysis.md` | reference benchmark on the Miller tier + BCI III-1 (protocol in `docs/baselines.md`) |
