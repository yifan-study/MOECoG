...
`pipelines/`) or a result; `ROADMAP.md` lists the milestones in week-sized chunks with their definitions of done;
`docs/moabb_lessons.md` records what MOABB did and what we copy. One-call benchmark:
