...
| ds003708 | openneuro | Basis profile curve identification to understand electrical  | ok | 1 subj; 1 file(s); 76 ch @ 2048 Hz; 600 s; 2 events in 1 classes; electrodes 89 (mni152nlin6sym);  | 6.8 |
...
| ds004457 | openneuro | Electrical stimulation of temporal and limbic circuitry prod | ok | 1 subj; 1 file(s); 154 ch @ 2048 Hz; 600 s; 54 events in 1 classes; electrodes 147 (acpc);  | 45.8 |
...
| ds004624 | openneuro | Intracranial recordings using BCI2000 and the CorTec BrainIn | error | AssertionError:  | 19.7 |
...
| ds004696 | openneuro | HAPwave_bids | ok | 1 subj; 1 file(s); 162 ch @ 2048 Hz; 600 s; 21 events in 1 classes; electrodes 165 (other);  | 39.9 |
...
| ds004774 | openneuro | Automatic Evoked Response Detection (ER-Detect) dataset | ok | 1 subj; 1 file(s); 76 ch @ 2048 Hz; 600 s; 2 events in 1 classes; electrodes 89 (other);  | 16.9 |
...
| ds004977 | openneuro | CARLA: Adjusted common average referencing for cortico-corti | ok | 1 subj; 3 file(s); 210 ch @ 4800 Hz; 543 s; 120 events in 1 classes; electrodes 238 (acpc);  | 97.5 |
...
| ds005592 | openneuro | ds005592 | blocked | 0 subjects; tasks ; 0.0 GB; BLOCKED: deleted by OpenNeuro as a duplicate of ds006107, which loads | 1.3 |
...
| ds006254 | openneuro | IEEG CCEP Recording | error | OSError: download of https://s3.amazonaws.com/openneuro.org/ds006254/sub-18/ieeg/sub-18_coordsystem.json?versionId=OSffUiqbJTNf7oVHSoA8cmhuAkA7bbN5 failed after | 7.5 |
| ds006392 | openneuro | HED schema library for SCORE annotations example | ok | 1 subj; 1 file(s); 194 ch @ 512 Hz; 191 s; 18 events in 9 classes; electrodes 166 (mni152lin);  | 1.1 |
...
| ds007703 | openneuro | Single pulse electrical stimulation in white matter modulate | blocked | 2 subjects; tasks Visual stimuli + CCEPs,Cortico-cortical evoked potentials - CCEPs,Cortico cortical Evoked Potentials, CCEPs,Cortico Cortical Evoked Potentials; 12.3 GB; BLOCKED: the snapshot lists only sidecar files (channels, events), no ieeg recordings; OpenNeuro also refuses HEAD on every file (checked 2026-09-10) | 31.6 |
...
| dandi-000469 | dandi | Rutishauser Sternberg WM | blocked | single-unit spike times only; no field potentials or voltage in the NWB files (verified 2026-09-10 by opening the files) | 7.3 |
| dandi-000004 | dandi | Rutishauser declarative memory | blocked | single-unit spike times only; no field potentials or voltage in the NWB files (verified 2026-09-10 by opening the files) | 8.7 |
| dandi-001616 | dandi | SUMMER movie single-neuron | blocked | single-unit spike times only; no field potentials or voltage in the NWB files (verified 2026-09-10 by opening the files) | 8.5 |
| dandi-000571 | dandi | Mayo CorTec BrainInterchange (MEF3) | blocked | MEF3 stored as .mefd directory trees on DANDI; pymef reader exists for BIDS, a DANDI folder fetcher is still to write |  |
...
| dandi-001535 | dandi | Natraj/Ganguly long-term ECoG BCI, BRAVO1 neural features (D | ok | 1 subj; 1 file(s); 256 ch @ 100 Hz; 2685 s; 1500 events in 9 classes; electrodes none; kappa 0.39 (n=1500) | 64.3 |
...
| gin-usz | blocked | GIN USZ intraoperative HFO | blocked | duplicate of ds004944, which loads; no separate loader needed |  |
